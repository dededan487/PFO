...
<head>
    ...
    <meta name="description"
        content="Découvrez notre collection exclusive de photos de haute qualité. Parcourez des images uniques dans différentes catégories et formats. Trouvez la photo parfaite pour votre projet dès maintenant." />
...
<header id='header' >
        ...
        <?php
          require get_template_directory() . '/templates_parts/header_bandeau.php';
         ?>
